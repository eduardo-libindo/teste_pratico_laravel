<div class="container mx-auto p-4">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <h1 class="text-2xl text-gray-700 font-bold py-4">Lista de Colaboradores</h1>
                ...
                <tbody>
                    ...
                    <tr class="border-b grey:border-gray-700">
                        ...
                        <td class="border px-4 py-3">
                            <!-- <a href="{{ route('colaborador.edit', $colaborador->id) }}" class="text-blue-500 hover:text-blue-700">Editar</a> -->
                            <!-- <button wire:click="delete({{ $colaborador->id }})" class="text-red-500 hover:text-red-700 ml-2">Deletar</button> -->

                            <a type="button" href="{{ route('colaborador.edit', $colaborador->id) }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
                                <svg class="mr-1.5 -ml-0.5 size-5 text-gray-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                            ...
                            <button wire:click="delete({{ $colaborador->id }})" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
        ...
        <div class="mt-4">
            <a type="button" href="{{ route('colaborador.create') }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-700 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
