<div class="container mx-auto p-4">
    <div class="bg-white shadow-md rounded-lg p-6">
        ...
        <h1 class="text-2xl text-gray-700 font-bold py-4">Lista de Grupos Econômicos</h1>
            ...
            <table class="w-full text-sm text-left text-gray-500 grey:text-gray-400">
                ...
                <tbody>
                    ...
                    <tr class="border-b grey:border-gray-700">
                        <td class="border px-4 py-3">{{ $grupo->id }}</td>
                        <td class="border px-4 py-3">{{ $grupo->nome }}</td>
                        <td class="border px-4 py-3">
                            <a type="button" href="{{ route('grupo-economico.edit', $grupo->id) }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
                                <svg class="mr-1.5 -ml-0.5 size-5 text-gray-600" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true" data-slot="icon">
                            ...
                            <button wire:click="delete({{ $grupo->id }})" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
        ...
        <div class="mt-4">
            <a type="button" href="{{ route('grupo-economico.create') }}" class="inline-flex items-center rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-700 ring-1 shadow-xs ring-gray-300 ring-inset hover:bg-gray-50">
